...
namespace futures {
    namespace detail {
        // --------------------------------------------------------------
        // continue tags for tag-dispatching and identifying each unwrapping
        // type
        //
        ...
        public:
            using valid = invoke_expr<is_invocable>;
            using result = invoke_expr<invoke_result>;
        };
        ...
        template <class Future, class Function, class... PrefixArgs>
        using continue_invoke_result_t = typename continue_invoke_result<
            Future,
            Function,
            PrefixArgs...>::type;
        ...
        static constexpr bool continue_is_invocable_for_v
            = continue_is_invocable_for<Tag, Future, Function, PrefixArgs...>::
                value;
