...
#include <futures/detail/bundled/asio/detail/null_global.hpp>
#elif defined(ASIO_WINDOWS)
#include <futures/detail/bundled/asio/detail/win_global.hpp>
#elif defined(ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/asio/detail/posix_global.hpp>
#elif defined(ASIO_HAS_STD_CALL_ONCE)
#include <futures/detail/bundled/asio/detail/std_global.hpp>
#else
