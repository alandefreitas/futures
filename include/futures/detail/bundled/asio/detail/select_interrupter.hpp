...
#include <futures/detail/bundled/asio/detail/socket_select_interrupter.hpp>
#elif defined(ASIO_HAS_EVENTFD)
#include <futures/detail/bundled/asio/detail/eventfd_select_interrupter.hpp>
#else
#include <futures/detail/bundled/asio/detail/pipe_select_interrupter.hpp>
#endif
