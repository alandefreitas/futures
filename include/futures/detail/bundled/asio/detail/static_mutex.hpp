...
#include <futures/detail/bundled/asio/detail/null_static_mutex.hpp>
#elif defined(ASIO_WINDOWS)
#include <futures/detail/bundled/asio/detail/win_static_mutex.hpp>
#elif defined(ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/asio/detail/posix_static_mutex.hpp>
#elif defined(ASIO_HAS_STD_MUTEX_AND_CONDVAR)
#include <futures/detail/bundled/asio/detail/std_static_mutex.hpp>
#else
