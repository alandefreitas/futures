...
#include <futures/detail/bundled/asio/detail/null_tss_ptr.hpp>
#elif defined(ASIO_HAS_THREAD_KEYWORD_EXTENSION)
#include <futures/detail/bundled/asio/detail/keyword_tss_ptr.hpp>
#elif defined(ASIO_WINDOWS)
#include <futures/detail/bundled/asio/detail/win_tss_ptr.hpp>
#elif defined(ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/asio/detail/posix_tss_ptr.hpp>
#else
