...
#include <futures/detail/bundled/boost/asio/detail/null_global.hpp>
#elif defined(BOOST_ASIO_WINDOWS)
#include <futures/detail/bundled/boost/asio/detail/win_global.hpp>
#elif defined(BOOST_ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/boost/asio/detail/posix_global.hpp>
#elif defined(BOOST_ASIO_HAS_STD_CALL_ONCE)
#include <futures/detail/bundled/boost/asio/detail/std_global.hpp>
#else
