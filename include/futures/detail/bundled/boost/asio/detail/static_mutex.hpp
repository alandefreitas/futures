...
#include <futures/detail/bundled/boost/asio/detail/null_static_mutex.hpp>
#elif defined(BOOST_ASIO_WINDOWS)
#include <futures/detail/bundled/boost/asio/detail/win_static_mutex.hpp>
#elif defined(BOOST_ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/boost/asio/detail/posix_static_mutex.hpp>
#elif defined(BOOST_ASIO_HAS_STD_MUTEX_AND_CONDVAR)
#include <futures/detail/bundled/boost/asio/detail/std_static_mutex.hpp>
#else
