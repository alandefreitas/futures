...
#include <futures/detail/bundled/boost/asio/detail/null_tss_ptr.hpp>
#elif defined(BOOST_ASIO_HAS_THREAD_KEYWORD_EXTENSION)
#include <futures/detail/bundled/boost/asio/detail/keyword_tss_ptr.hpp>
#elif defined(BOOST_ASIO_WINDOWS)
#include <futures/detail/bundled/boost/asio/detail/win_tss_ptr.hpp>
#elif defined(BOOST_ASIO_HAS_PTHREADS)
#include <futures/detail/bundled/boost/asio/detail/posix_tss_ptr.hpp>
#else
