...
#include <futures/detail/bundled/boost/date_time/locale_config.hpp> //set up locale configurations
...
//
#include <futures/detail/bundled/boost/config/auto_link.hpp>
