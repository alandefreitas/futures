...
#include <futures/detail/bundled/boost/integer_fwd.hpp>  // self include

#include <futures/detail/bundled/boost/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <futures/detail/bundled/boost/limits.hpp>          // for ::std::numeric_limits
#include <futures/detail/bundled/boost/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
