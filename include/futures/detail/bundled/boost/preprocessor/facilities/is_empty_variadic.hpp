...
#include <futures/detail/bundled/boost/preprocessor/punctuation/is_begin_parens.hpp>
#include <futures/detail/bundled/boost/preprocessor/facilities/detail/is_empty.hpp>
#
