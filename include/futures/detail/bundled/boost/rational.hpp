...
#include <futures/detail/bundled/boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <futures/detail/bundled/boost/operators.hpp>   // for boost::addable etc
#include <cstdlib>               // for std::abs
#include <futures/detail/bundled/boost/call_traits.hpp> // for boost::call_traits
#include <futures/detail/bundled/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <futures/detail/bundled/boost/assert.hpp>      // for BOOST_ASSERT
#include <futures/detail/bundled/boost/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <futures/detail/bundled/boost/static_assert.hpp>  // for BOOST_STATIC_ASSERT
