...
#include <futures/detail/bundled/boost/type_index/type_index_facade.hpp>
...
#include <futures/detail/bundled/boost/core/demangle.hpp>
...
#else
#include <futures/detail/bundled/boost/container_hash/hash.hpp>
#endif

#if (defined(__EDG_VERSION__) && __EDG_VERSION__ < 245) \
        || (defined(__sgi) && defined(_COMPILER_VERSION) && _COMPILER_VERSION <= 744)
#include <futures/detail/bundled/boost/type_traits/is_signed.hpp>
#include <futures/detail/bundled/boost/type_traits/make_signed.hpp>
