...
namespace futures {
    namespace detail {
        ...
        /// versions of `set_value`, the main purpose of this task base class is
        /// to nullify the function type and allocator from the concrete task
        ...
        /// extension of and analogous with shared states. The main difference
        /// is that tasks also define a function that specify how to create the
        /// state, with the `run` function.
        ///
        /// In practice, a shared_task is to a packaged_task what a shared_state
        /// is to a promise.
        ///
        /// @tparam R Type returned by the task callable
        /// @tparam Args Argument types to run the task callable
        ...
        class shared_task : public shared_task_base<R, Options, Args...> {
            ...
            using allocator_type = boost::
                allocator_rebind_t<Allocator, shared_task>;
        ...
        private:
            void
            run_impl(std::true_type, Args &&...args) {
                apply(
            ...
            void
            run_impl(std::false_type, Args &&...args) {
