...
namespace futures {
    namespace detail {
        ...
        struct launch_result_impl<
            Function,
            std::enable_if_t<is_invocable_v<std::decay_t<Function>, Args...>>,
            Args...> {
            using type = invoke_result_t<std::decay_t<Function>, Args...>;
        };
        ...
        ///
        /// When the function expects a stop token, we return a jcfuture,
        /// because it has needs a token and continuations.
        template <class Function, class... Args>
