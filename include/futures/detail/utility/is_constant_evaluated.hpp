...
#    define FUTURES_HAS_GCC6_CONSTANT_EVALUATED
         ...
         *
         * While testing whether initializers of following variables are
         * constant initializers, compilers may first perform a trial constant
         * evaluation of the initializers:
         *
         ...
         *
         * @return true if the evaluation of the call occurs within the
         * evaluation of an expression or conversion that is manifestly
         * constant-evaluated; otherwise false.
         */
        constexpr bool
    ...
    || defined(FUTURES_HAS_GCC6_CONSTANT_EVALUATED)
...
#    define FUTURES_CONSTANT_EVALUATED_CONSTEXPR
         ...
         * here.
         */
#    define FUTURES_CONSTANT_EVALUATED_CONSTEXPR_DECLARE constexpr
#else
#    define FUTURES_CONSTANT_EVALUATED_CONSTEXPR_DECLARE inline
#endif
