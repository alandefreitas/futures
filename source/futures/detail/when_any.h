...
namespace futures {
    ...
    template <class Sequence> class when_any_future {
      ...
      private:
        /// \section Helpers to infer the type for the notifiers
      ...
      private:
        ...
        /// \section Variables for the notifiers to indicate if the future is ready
    ...
    /// \section Define when_any_future as a kind of future
    ...
    namespace detail {
        ...
        template <typename Sequence>
        struct is_when_any_range_future<when_any_future<Sequence>, std::enable_if_t<ranges::range<Sequence>>>
            : std::true_type {};
