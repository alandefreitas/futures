...
#include <futures/adaptor/detail/traits/is_executor_then_function.h>
...
namespace futures {
    ...
    /// \name Forward declarations for base classes
    /// @{
    namespace detail {
    ...
    namespace detail {
        ...
        template <typename ScheduleMethod, typename Executor, typename Function,
                  std::enable_if_t<is_executor_then_async_input_v<Executor, Function>, int> = 0>
        ...
        class
          ...
          public:
            ...
            /// \name Make async/then/when_all/when_any functions friends
            /// @{
            template <typename ScheduleMethod, typename Executor, typename Function,
